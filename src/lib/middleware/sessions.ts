...
* @returns {Promise<Object>} The created token, or undefined if the token already exists
*/
...
* @returns {Promise<Object>} The token, or undefined if it doesn't exist
*/
...
* @returns {Promise<Object>} The deleted token, or undefined if it doesn't exist
*/
