import { resetPasswordFormSchemaSecondStep, type ResetPasswordFormSchemaSecondStep } from "$lib/middleware/validations";
...
export const actions: Actions = {
  confirm: async (event) => {
    ...
    redirect(("/auth/reset-password/[userId=userId]/new-password", { userId }), flashMessage, cookies);
  },
  ...
  resendEmail: async (event) => {
    ...
    redirect(("/auth/reset-password/[userId=userId]", { userId }), flashMessage, cookies);
  }
};
